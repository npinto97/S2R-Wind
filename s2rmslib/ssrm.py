...
class S2RM:
    ...
    def _inner_test(self, data_name, selected):
        ...
        print('RF1 : {}'.format(mean_squared_error(result[0], val_data_y)))
        print('RF2 : {}'.format(mean_squared_error(result[1], val_data_y)))
        print('RF3 : {}'.format(mean_squared_error(result[2], val_data_y)))
        print('co-training : {}'.format(mean_squared_error(result[3], val_data_y)))
